...
pub fn log_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        ...
        Field::new("origints", DataType::Int64, false),
    ]))
}

pub fn hisysevent_all_event_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
        Field::new("domain", DataType::Utf8, true),
        Field::new("event_name", DataType::Utf8, true),
        Field::new("ts", DataType::Int64, true),
        Field::new("type", DataType::Int64, true),
        ...
        Field::new("contents", DataType::Utf8, true),
    ]))
}

pub fn hisysevent_measure_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
        ...
        Field::new("key", DataType::Utf8, false),
        Field::new("type", DataType::Int32, false),
        Field::new("int_value", DataType::Float64, true),
        Field::new("string_value", DataType::Utf8, true),
    ]))
}

pub fn perf_report_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
        Field::new("report_type", DataType::Utf8, false),
        Field::new("report_value", DataType::Utf8, true),
    ]))
}

pub fn perf_files_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
        Field::new("file_id", DataType::UInt64, false),
        Field::new("serial_id", DataType::UInt32, true),
        Field::new("symbol", DataType::Utf8, true),
        Field::new("path", DataType::Utf8, true),
    ]))
}

pub fn perf_thread_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
...
pub fn perf_sample_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
        Field::new("callchain_id", DataType::UInt32, true),
        Field::new("timeStamp", DataType::Int64, false),
        Field::new("thread_id", DataType::UInt32, false),
        Field::new("event_count", DataType::UInt64, false),
        Field::new("event_type_id", DataType::UInt64, false),
        Field::new("timestamp_trace", DataType::Int64, false),
        Field::new("cpu_id", DataType::UInt32, false),
        Field::new("thread_state", DataType::Utf8, true),
    ]))
}

pub fn perf_callchain_schema() -> SchemaRef {
    Arc::new(Schema::new(vec![
        Field::new("id", DataType::UInt64, false),
        Field::new("callchain_id", DataType::UInt32, false),
        Field::new("depth", DataType::UInt32, false),
        Field::new("ip", DataType::UInt64, false),
        Field::new("vaddr_in_file", DataType::UInt64, true),
        Field::new("offset_to_vaddr", DataType::UInt64, true),
        Field::new("file_id", DataType::UInt64, true),
        Field::new("symbol_id", DataType::UInt64, true),
        Field::new("name", DataType::Utf8, true),
        Field::new("source_file_id", DataType::Utf8, true),
        Field::new("line_number", DataType::UInt64, true),
    ]))
}
