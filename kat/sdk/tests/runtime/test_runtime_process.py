...
from kat._runtime import __main__ as runtime_main
from kat._runtime.pack import _workflow_entries, inspect_workflow
...
""",
    ...
    def test_public_trace_streamer_inspection_needs_no_pack(self) -> None:
        ...
        self.assertEqual(provider["module"], "kat.providers.trace_streamer")
    ...
    def test_public_provider_inspection_needs_no_pack(self) -> None:
        ...
        self.assertEqual(response["status"], "success", response)
        provider = response["result"]["provider"]
        self.assertEqual(provider["module"], "kat.providers.ftrace")
    ...
    def test_public_inspection_reads_knowledge_without_constructing(self) -> None:
        from kat._runtime.provider_inspection import (
