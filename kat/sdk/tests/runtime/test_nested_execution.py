...
import kat
from kat._runtime.datasource import WorkflowOperation
from kat._runtime.execution import (
...
from kat._runtime.inspection import compile_declared_workflow
from kat._runtime.request import RunCandidateRef
...
class NestedWorkflowContextTest(unittest.TestCase):
    ...
    def test_catalog_construction_failure_is_a_sanitized_run_error(self) -> None:
        ...
        with self.assertLogs("kat._runtime.execution", level="ERROR"):
