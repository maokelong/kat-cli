...
from kat._runtime.request import TestPackRequest as _TestPackRequest
from kat._runtime.request import RunWorkflowRequest as _RunWorkflowRequest
from kat._runtime.request import RuntimeRequestError, read_request
...
''',
        ...
        self.assertIn("kat/_runtime/testing.py", terminal.replace("\\", "/"))
...
''',
    ...
    def test_pytest_monkeypatch_cannot_replace_workflow_runtime(self) -> None:
        pack = self.pack()
        self.write_test(pack, "test_runtime_isolation.py", '''import kat._runtime.execution as execution
...
''')
    ...
    def test_unexpected_eager_output_error_keeps_its_traceback(self) -> None:
        ...
        self.write_test(
            ...
            '''import kat._runtime.testing as testing
