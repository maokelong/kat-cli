...
class AssembleSkillTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        for name in ("kat", "kat-analyze", "kat-author", "kat-review", "dev-sdk"):
    ...
    def test_assembly_maps_five_skills_and_each_shared_input_once(self) -> None:
        ...
        self.assertEqual(
            ...
            {"kat", "kat-analyze", "kat-author", "kat-review", "dev-sdk"},
        )
        self.assertEqual(
    ...
    def test_whole_collection_move_preserves_sibling_resource_paths(self) -> None:
        ...
        for task in ("kat-analyze", "kat-author", "kat-review", "dev-sdk"):
